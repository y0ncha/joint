...
| Task     | Description                                                                                                                                                                                                                                                                 | Status  | Date |
| -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ---- |
| TASK-006 | Run `bun run test src/app/manifest.test.ts src/app/layout.test.tsx` and require the manifest contract, icon existence, Apple web-app metadata, theme color, and viewport-fit assertions to pass.                                                                            | In progress | 2026-08-09 |
