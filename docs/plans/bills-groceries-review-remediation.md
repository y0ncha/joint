...
- **CON-003**: Do not run `bun run build`, create or switch branches, push, deploy, or execute linked Supabase commands.
...
| Task     | Description                                                                                                                                                                                                                                                                                                                                            | Status  | Date |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ---- |
| TASK-011 | Define one server-safe exported chart-ID tuple in `src/lib/bills-groceries-chart-ids.ts`, re-export it from `src/components/bills-groceries-dashboard.tsx`, derive `BillsGroceriesChartId` from it, replace every `yoy` chart identity and related identifier with `year-over-year`, and type `ChartCard.id` as `BillsGroceriesChartId`. | Complete | 2026-08-01 |
...
| Task     | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Status  | Date |
| -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ---- |
| TASK-021 | Run `bun run test -- src/lib/date-range.test.ts src/lib/bills-groceries.test.ts src/lib/bills-groceries-data.test.ts src/lib/validation.test.ts src/lib/financial-report.test.ts src/app/actions/profile.test.ts src/components/bills-groceries-dashboard.test.tsx src/components/groceries-budget-settings-control.test.tsx src/app/'(app)'/bills-groceries/page.test.tsx src/app/'(app)'/bills-groceries/detail-pages.test.tsx src/app/'(app)'/settings/page.test.tsx src/components/settings-save-control.test.ts` and record the exact passing counts. | Complete | 2026-08-01 |
| TASK-022 | Run `bun run lint`, `bun run test`, and `git diff --check` without running `bun run build`, and record each result separately.                                                                                                                                                                                                                                                                                                                                                                                                                             | Complete | 2026-08-01 |
| TASK-023 | Run stale scans for standalone `yoy`, `bills.yearOverYear`, removed local UTC helpers, hand-written detail paths, and unpaginated transaction reads, and verify every remaining match is intentional and documented.                                                                                                                                                                                                                                                                                                                                       | Complete | 2026-08-01 |
| TASK-024 | In the local authenticated browser, verify all four dashboard detail controls, canonical redirects for invalid/legacy detail queries, Year-over-year selected-Bill current/missing-prior values, a server-rejected groceries budget with adjacent announced focusable error, and unchanged desktop/mobile Settings and navigation visuals.                                                                                                                                                                                                                 | Complete | 2026-08-01 |
...
- **FILE-007**: `src/lib/bills-groceries-chart-ids.ts`, `src/components/bills-groceries-dashboard.tsx`, and `src/components/bills-groceries-dashboard.test.tsx` — server-safe typed route identities, derived detail links, and selected-Bill YoY rendering.
