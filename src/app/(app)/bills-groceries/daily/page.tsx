...
export default async function DailyPage({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
  ...
  return (
    <WorkspaceShell opaqueContent>
      <BillsGroceriesChartDetail chart="daily" data={data} billIds={selected.billIds} billId={selected.billId} period={selected.period} />
    </WorkspaceShell>
  );
}
