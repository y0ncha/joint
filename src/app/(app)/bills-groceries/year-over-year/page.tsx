...
export default async function YearOverYearPage({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
  ...
  return (
    <WorkspaceShell opaqueContent>
      <BillsGroceriesChartDetail chart="yoy" data={data} billIds={selected.billIds} billId={selected.billId} period={selected.period} />
    </WorkspaceShell>
  );
}
