...
export default async function TransactionsPage({ searchParams }: { searchParams: Promise<{ import?: string; month?: string }> }) {
  const { import: importRequested, month: requestedMonth } = await searchParams;
