    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          "[&_[data-slot=input]]:h-11 [&_[data-slot=input]]:w-full [&_[data-slot=input]:not(.rounded-none)]:rounded-xl [&_[data-slot=select-trigger]]:h-11 [&_[data-slot=select-trigger]]:w-full [&_[data-slot=select-trigger]]:rounded-xl",
          className,
