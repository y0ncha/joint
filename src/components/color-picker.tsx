...
export function ColorPicker({ color, onChange, presetColors = sharedPastelColors.map(({ value }) => value), recentColors = [], allowCustom = true }: { color: string; onChange: (color: string) => void; presetColors?: string[]; recentColors?: string[]; allowCustom?: boolean }) {
