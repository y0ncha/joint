...
values
  ...
  ('00000000-0000-0000-0000-000000000533', '00000000-0000-0000-0000-000000000510', '00000000-0000-0000-0000-000000000521', 'Groceries', '#ffedec'),
...
select results_eq(
  ...
  $$ values ('Meals'::text, 7800::numeric), ('Groceries'::text, 100::numeric) $$,
...
select results_eq(
  ...
  $$ values
    ...
    ('00000000-0000-0000-0000-000000000550'::uuid, 'Food'::text, 'Groceries'::text),
